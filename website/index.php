                ...
                <div class="card-oferta mais-vendido">
                    ...
                    <div class="footer-card">
                        <div class="item item-apps">
                            <div class="left">
                                <div class="ico">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                                        ...
                                        <mask id="mask0_2188_1094" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="12" y="12" width="24" height="24">
                                            <rect x="12" y="12" width="24" height="24" fill="#D9D9D9" />
                                        </mask>
                                        <g>
                                            <path d="M14.5 31.5V29.25H16.5V18.3077C16.5 17.8106 16.677 17.385 17.031 17.031C17.385 16.677 17.8106 16.5 18.3077 16.5H32.5V18H18.3077C18.2179 18 18.1442 18.0288 18.0865 18.0865C18.0288 18.1442 18 18.2179 18 18.3077V29.25H23.7402V31.5H14.5ZM27.0288 31.5C26.7728 31.5 26.5581 31.4133 26.3848 31.24C26.2116 31.0668 26.125 30.8522 26.125 30.596V21.0962C26.125 20.8401 26.2116 20.6254 26.3848 20.4523C26.5581 20.2789 26.7728 20.1923 27.0288 20.1923H32.6057C32.8617 20.1923 33.0764 20.2789 33.2498 20.4523C33.4229 20.6254 33.5095 20.8401 33.5095 21.0962V30.596C33.5095 30.8522 33.4229 31.0668 33.2498 31.24C33.0764 31.4133 32.8617 31.5 32.6057 31.5H27.0288ZM27.625 29.25H32.0095V21.6923H27.625V29.25Z" fill="white" />
                                        </g>
                                    </svg>
                                </div>
                                <div class="right-footer-card">
                            ...
                            <div class="right">
                                <div class="item-ico">
                                    <img src="/website/img/ico-card-deezer.png" alt="Deezer">
                                </div>
                                <div class="item-ico">
                                    <img src="/website/img/ico-card-looke.png" alt="Looke">
                                </div>
                                <div class="item-ico">
                                    <img src="/website/img/ico-card-conhecimento.png" alt="Super conhecimento">
                                </div>
                            </div>
                        </div>
                        <div class="item">
