    ...
    <div class="aligner">
        <div id="carousel-banners" class="owl-carousel owl-theme">
            <div class="item">
                <a href="#">
                    <!-- desktop -->
                    <img src="/img/index/banner_1.png" class="d-none d-md-block" alt="Turbo Line internet fibra óptica">
                    <!-- mobille -->
                    <img src="/img/index/banner_1_mobille.png" class="d-block d-md-none" alt="Turbo Line internet fibra óptica">
                </a>
            </div>
            <div class="item">
                <a href="#">
                    <!-- desktop -->
                    <img src="/img/index/banner_4.png" class="d-none d-md-block" alt="Turbo Line internet fibra óptica">
                    <!-- mobille -->
                    <img src="/img/index/banner_4_mobille.png" class="d-block d-md-none" alt="Turbo Line internet fibra óptica">
                </a>
            </div>
            <div class="item">
                <a href="#">
                    <!-- desktop -->
                    <img src="/img/index/banner_3.png" class="d-none d-md-block" alt="Turbo Line internet fibra óptica">
                    <!-- mobille -->
                    <img src="/img/index/banner_3_mobille.png" class="d-block d-md-none" alt="Turbo Line internet fibra óptica">
                </a>
            </div>
        </div>
        <!-- <div class="owl-dots">
    ...
    <div class="container">
        ...
        <div class="contain-cards-ofertas">
            <div class="coluna">
                <div class="card-oferta">
                    ...
                    <div class="body-card">
                        ...
                        <span class="validade-oferta">Valor fixo por 12 mêses</span>
                        <a href="https://wa.me/556230943385" target="_blank" class="assinatura-card">
                            <div class="ico">
            ...
            <div class="coluna">
                <div class="card-oferta oferta">
                    ...
                    <div class="body-card">
                        ...
                        <span class="validade-oferta">Oferta válida por 3 meses</span>

                        <span class="validade-oferta">Após este período</span>
                        <span class="preco">R$ 99,90/mês</span>
                ...
                <div class="card-oferta">
                    ...
                    <div class="footer-card">
                        <div class="item item-apps dark">
                            ...
                            <div class="right">
                                <div class="item-ico">
                                    <img src="/img/ico-card-deezer.png" alt="Deezer">
                                </div>
                                <div class="item-ico">
                                    <img src="/img/ico-card-looke.png" alt="Looke">
                                </div>
                                <div class="item-ico">
                                    <img src="/img/ico-card-conhecimento.png" alt="Super conhecimento">
                                </div>
                            </div>
                        </div>
                        <div class="item">
            ...
            <div class="coluna">
                <div class="card-oferta mais-vendido">
                    ...
                    <div class="body-card">
                        <span class="preco">R$ 120,00/mês</span>
                        <span class="validade-oferta">Valor fixo por 12 meses</span>
                        <a href="https://wa.me/556230943385" target="_blank" class="assinatura-card">
                            <div class="ico">
                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="18" viewBox="0 0 17 18" fill="none">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10.76 9.81225C10.4895 9.81225 9.96882 10.823 9.65615 10.823C9.57469 10.8196 9.49562 10.7945 9.4271 10.7503C8.84394 10.458 8.33349 10.1562 7.8543 9.69809C7.45801 9.32289 7.021 8.76008 6.79267 8.27071C6.76116 8.22436 6.74282 8.17033 6.73959 8.11438C6.73959 7.87442 7.45946 7.42723 7.45946 7.03094C7.45946 6.92696 6.92865 5.51121 6.85448 5.33306C6.7505 5.06257 6.69887 4.97895 6.4182 4.97895C6.28222 4.97895 6.15643 4.94768 6.03281 4.94768C5.81322 4.94768 5.64743 5.0313 5.49037 5.17673C4.99009 5.64573 4.73996 6.1351 4.7196 6.82298V6.90587C4.70869 7.62574 5.06281 8.34343 5.4591 8.92732C6.35348 10.2507 7.28131 11.4069 8.7705 12.0831C9.21842 12.2918 10.2502 12.7288 10.7498 12.7288C11.3438 12.7288 12.3131 12.3543 12.5516 11.7704C12.6462 11.5305 12.7291 11.2396 12.7291 10.9793C12.7291 10.9371 12.729 10.8746 12.7072 10.823C12.6345 10.6979 10.9374 9.81225 10.76 9.81225ZM8.64543 15.3334C7.37511 15.3334 6.11498 14.948 5.0519 14.25L2.5309 15.0513L3.35403 12.6248C2.54201 11.5115 2.10412 10.1693 2.10334 8.79134C2.10334 5.18836 5.04099 2.25072 8.64543 2.25072C12.2499 2.25072 15.1882 5.18764 15.1882 8.79062C15.1882 12.3958 12.2506 15.3334 8.64543 15.3334ZM8.64543 0.9375C4.31167 0.9375 0.79231 4.45831 0.79231 8.79062C0.79231 10.2187 1.17769 11.625 1.91647 12.8437L0.5 17.0626L4.84394 15.6665C6.04003 16.3268 7.38762 16.6638 8.75373 16.6444C10.1199 16.6249 11.4573 16.2496 12.6341 15.5555C13.8109 14.8614 14.7864 13.8724 15.4643 12.6862C16.1423 11.5 16.4992 10.1576 16.5 8.79134C16.5 4.45904 12.9792 0.9375 8.64543 0.9375Z" fill="white" />
            ...
            <div class="coluna">
                <div class="card-oferta mais-vendido">
                    ...
                    <div class="body-card">
                        <span class="preco">R$ 119,90/mês</span>
                        <span class="validade-oferta">Valor fixo por 12 meses</span>
                        <a href="https://wa.me/556230943385" target="_blank" class="assinatura-card">
                            <div class="ico">
                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="18" viewBox="0 0 17 18" fill="none">
            ...
            <div class="coluna">
                <div class="card-oferta mais-vendido">
                    ...
                    <div class="body-card">
                        <span class="preco">R$ 139,90/mês</span>
                        <span class="validade-oferta">Valor fixo por 12 meses</span>
                        <a href="https://wa.me/556230943385" target="_blank" class="assinatura-card">
                            <div class="ico">
                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="18" viewBox="0 0 17 18" fill="none">
        ...
        <div class="contain-ver-mais">
            <button type="button" class="btn-ver-mais">
                ...
                <div class="ico">
                    <svg id="ico-ver-mais" xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33" fill="none">
...
<section class="quem-somos-home" data-animation="true">
    <div class="container">
        <div class="top">
            <div class="col-left">
                <img src="/img/index/quem-somos-img.png" alt="Institucional TurboLine">
            </div>
            <div class="col-right">
                <span class="titulo">
                    A internet que <br>
                ...
                <div class="contain-btns">
                    <a href="https://wa.me/556230943385" target="_blank" class="saiba-mais">Saiba mais</a>
                    <a href="https://wa.me/556230943385" target="_blank" class="fale-conosco">
                        <div class="ico">
    ...
    <div class="container">
        <div class="top" data-animation="true">
            ...
            <fieldset class="contain-cards-serv">
                <div class="card-serv">
                    <div class="top">
                        <img src="/img/index/serv-deezer.png" alt="Deezer">
                    </div>
                    <div class="body">
                ...
                <div class="card-serv">
                    <div class="top">
                        <img src="/img/index/serv-looke.png" alt="Looke">
                    </div>
                    <div class="body">
                ...
                <div class="card-serv">
                    <div class="top">
                        <img src="/img/index/serv-conhecimento.png" alt="Super conhecimento">
                    </div>
                    <div class="body">
            ...
            <div class="grid-bottom">
                <div class="left">
                    ...
                    <div class="contain-btn">
                        <a href="https://wa.me/556230943385" target="_blank">Consultar disponibilidade</a>
                    </div>
                </div>
                <div class="right">
                    <img src="/img/index/bg-disponibilidade.png" alt="Disponibilidade Turbo Line">
                </div>
            </div>
        </div>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const colunas = document.querySelectorAll('.contain-cards-ofertas .coluna');
        btnVerMais.addEventListener('click', () => {
            const ultimasColunas = Array.from(colunas).slice(-3);
            const estaoVisiveis = ultimasColunas.every(coluna => coluna.style.display === 'block');
            ultimasColunas.forEach(coluna => {
                if (estaoVisiveis) {
                    coluna.style.transition = 'opacity 0.5s ease';
                    coluna.style.opacity = '0';
                    setTimeout(() => {
                        coluna.style.display = 'none';
                        document.getElementById('ico-ver-mais').style.transform = 'rotate(0deg)';
                    }, 500);
                } else {
                    ...
                    setTimeout(() => {
                        ...
                        document.getElementById('ico-ver-mais').style.transform = 'rotate(180deg)';
                    }, 10);
                }
            });
            btnVerMais.querySelector('span').textContent = estaoVisiveis ?
                'Ver mais ofertas' :
                'Ocultar ofertas';
        });
    });
